...
LogProtoServer *
log_proto_text_server_multi_transport_new(MultiTransportFactory *multitransport_factory,
                                          const LogProtoServerOptions *options)
{
  msg_error("Multi transport constructor not supported in LogProtoTextServer");
  return NULL;
}
