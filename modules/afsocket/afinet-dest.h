...
typedef struct _AFInetDestDriver
{
  ...
  guint successfull_probes_required;
  guint successfull_probes_received;
...
void afinet_dd_set_failback_successfull_probes_required(LogDriver *s, gint successfull_probes_required);
const gchar *afinet_dd_get_hostname(AFInetDestDriver *self);
