...
struct _TransportMapper
{
  ...
  LogTransportFactory *(*construct_log_transport_factory)(TransportMapper *self);
...
transport_mapper_construct_log_transport_factory(TransportMapper *self)
{
  return self->construct_log_transport_factory(self);
}
